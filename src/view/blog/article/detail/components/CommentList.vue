<template>
    <div class="common-comment-list-wrapper">
        <ul class="common-comment-list">
            <li
                class="flex-start common-comment-list-item"
                v-for="(item, index) of commentList"
                :key="item.id"
            >
                <img
                    :src="item.avatar || commentAvatar"
                    alt=""
                    class="item-avatar"
                />
                <!-- 右边内容 -->
                <div class="item-right-box">
                    ...
                    <div class="item-bottom flex-space-between">
                        ...
                        <div class="item-bottom flex-end">
                            <div
                                class="item-bottom-good flex-start"
                            ...
                            >
                                ...
                                <span v-show="item.favorite">{{
                                    item.favorite
                                }}</span>
                            </div>
                            <div
                                class="item-bottom-good reply-hover flex-start"
                                @click.stop="showComment(item, index, 1)"
                            >
                                <img :src="reply" alt="" />
                                <span>回复</span>
                            </div>
                    ...
                    <!-- 回复评论 -->
                    <div
                        class="item-reply-list-container"
                    ...
                    >
                        <ul class="common-comment-list">
                            <li
                                class="flex-start common-comment-list-item"
                                v-for="(subComment,
                                subIndex) of item.subComment"
                                :key="subComment.id"
                            >
                                <img
                                    :src="subComment.avatar || commentAvatar"
                                    alt=""
                                    class="item-avatar"
                                />
                                <!-- 右边内容 -->
                                <div class="item-right-box">
                                    ...
                                    <div class="item-bottom flex-space-between">
                                        <span>{{
                                            subComment.createTime | formatDate
                                        }}</span>
                                        <div class="item-bottom flex-end">
                                            <div
                                                class="item-bottom-good flex-start"
                                                @click="
                                                    handleLike(item, subComment)
                                                "
                                            >
                                                <img
                                                    :src="selectGood"
                                    ...
                                    <comment-input
                                        backgroundColor="#fff"
                                        v-if="subComment.id === replyLevel2Id"
                                        @submit="submit"
                                        :placeholder="
                                            '回复' + subComment.userName
                                        "
    ...
    methods: {
        ...
        submit(e, value) {
            ...
            this.$emit(
                'submit',
                e,
                Object.assign({}, this.currentComment, value),
                2
            );
        },
         ...
         */
        handleLike(item, subComment) {
            this.$emit('handleLike', item, subComment);
        },
