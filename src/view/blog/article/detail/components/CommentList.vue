<template>
    <div class="common-comment-list-wrapper">
        <ul class="common-comment-list">
            <li class="flex-start common-comment-list-item"
                v-for="(item, index) of commentList"
                :key="item.id">
                <img :src="item.avatar || commentAvatar"
                     alt=""
                     class="item-avatar">
                <!-- 右边内容 -->
                <div class="item-right-box">
                    ...
                    <div class="item-bottom flex-space-between">
                        ...
                        <div class="item-bottom flex-end">
                            <div class="item-bottom-good flex-start"
                            ...
                            <div class="item-bottom-good reply-hover flex-start"
                                 @click="showComment(item, index, 1)">
                                <img :src="reply"
                                     alt="">
                                <span>回复</span>
                            </div>
                    ...
                    <comment-input v-if="item.id === replyLevel1Id"
                                   @submit="submit"
                    ...
                    <div class="item-reply-list-container"
                        ...
                        <ul class="common-comment-list">
                            <li class="flex-start common-comment-list-item"
                                v-for="(subComment, subIndex) of item.subComment"
                                :key="subComment.id">
                                <img :src="subComment.avatar ||commentAvatar"
                                     alt=""
                                     class="item-avatar">
                                <!-- 右边内容 -->
                                <div class="item-right-box">
                                    ...
                                    <div class="item-bottom flex-space-between">
                                        ...
                                        <div class="item-bottom flex-end">
                                            <div class="item-bottom-good flex-start"
                                                 @click="handleLike(item, subComment)">
                                                <img :src="selectGood"
                                                     alt=""
                                                     v-if="showFavorite(item, subComment)">
                                                <img :src="good"
                                                     alt=""
                                                     v-else>
                                            ...
                                            <div class="item-bottom-good reply-hover flex-start"
                                                 @click="showComment(subComment, subIndex, 2)">
                                                <img :src="reply"
                                                     alt="">
                                                <span>回复</span>
                                            </div>
                                    ...
                                    <comment-input backgroundColor="#fff"
